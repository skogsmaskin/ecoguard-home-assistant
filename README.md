...
Instead of showing all sensors individually, you can use a pre-configured dashboard that organizes your EcoGuard data into a clean, organized view.

### Quick Setup

1. In Home Assistant, go to **Settings** → **Dashboards**
2. Click the **three dots menu** (⋮) → **Import dashboard**
3. Navigate to `custom_components/ecoguard/lovelace/dashboard.yaml`
4. Select the file and click **Import**

The dashboard includes:
- **Overview**: Key metrics, monthly cost gauge, consumption trends
- **Daily Details**: Daily consumption and costs with 30-day history
- **Monthly Details**: Monthly totals, billing information, and cost breakdown

For more information and customization options, see `custom_components/ecoguard/lovelace/README.md`.

For advanced dashboard options including custom Lovelace cards, see `DASHBOARD_GUIDE.md` in the repository root.
